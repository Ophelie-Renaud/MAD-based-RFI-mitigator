...
int main(void) {
  ...
  void* (*coreThreadComputations[_PREESM_NBTHREADS_])(
      void*) = {
        &computationThread_Core0, &computationThread_Core1, &computationThread_Core2, &computationThread_Core3, &computationThread_Core4, &computationThread_Core5, &computationThread_Core6, &computationThread_Core7
      };
