...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 1 \
			corename mem_read_top_rfi_C_control_axilite \
			name mem_read_top_rfi_C_control_s_axi \
			ports {$port_control} \
			op interface \
			interrupt_mode none \
			is_flushable 0 \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler mem_read_top_rfi_C_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    is_flushable 0 \ 
    mem_style block \ 
    name {mem_read_top_rfi_C_gmem_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler mem_read_top_rfi_C_gmem_m_axi BINDTYPE interface TYPE interface_m_axi
}
...
# RegSlice definition:
set ID 5
set RegSliceName mem_read_top_rfi_C_regslice_both
set RegSliceInstName mem_read_top_rfi_C_regslice_both_U
set CoreName ap_simcore_mem_read_top_rfi_C_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
