...
# 2 "<built-in>" 2
# 1 "mem_read_top_rfi_C.cpp" 2
# 37 "mem_read_top_rfi_C.cpp"
...
# 39 "mem_read_top_rfi_C.cpp" 2




# 1 "./PreesmAutoDefinedSizes.h" 1
# 44 "mem_read_top_rfi_C.cpp" 2
...
static bool readInput(T* in, hls::stream<T> &inStream) {
 ...
 if (current_rate < rate && current_factor < factor) {
  VITIS_LOOP_57_1: for (int i = 0; i < burst_size; i++) {
