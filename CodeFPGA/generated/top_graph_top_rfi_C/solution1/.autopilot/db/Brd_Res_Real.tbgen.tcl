...
set C_modelArgList {
	...
	{ stream_RFI_Filter_filtered_real_data_o_Brd_Res_Real_in int 16 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "filtered_real_1_o_stream", "interface" : "axis", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "stream_RFI_Filter_filtered_real_data_o_Brd_Res_Real_in", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY", "extern" : 0} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_RFI_Filter_filtered_real_data_o_Brd_Res_Real_in_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "stream_RFI_Filter_filtered_real_data_o_Brd_Res_Real_in", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	stream_RFI_Filter_filtered_real_data_o_Brd_Res_Real_in { ap_fifo {  { stream_RFI_Filter_filtered_real_data_o_Brd_Res_Real_in_dout fifo_data 0 16 }  { stream_RFI_Filter_filtered_real_data_o_Brd_Res_Real_in_empty_n fifo_status 0 1 }  { stream_RFI_Filter_filtered_real_data_o_Brd_Res_Real_in_read fifo_update 1 1 } } }
}
