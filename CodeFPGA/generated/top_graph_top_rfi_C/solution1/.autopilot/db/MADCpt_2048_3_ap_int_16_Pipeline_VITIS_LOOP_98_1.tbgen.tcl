set moduleName MADCpt_2048_3_ap_int_16_Pipeline_VITIS_LOOP_98_1
set isTopModule 0
...
set C_modelName {MADCpt<2048, 3, ap_int<16> >_Pipeline_VITIS_LOOP_98_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ RDRi_V int 16 regular {array 2048 { 0 3 } 0 1 }  }
	{ RDIi_V int 16 regular {array 2048 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "RDRi_V", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "RDIi_V", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ stream_Brd_Acq_Real_out_1_MAD_Computation_raw_data_real_i_dout sc_in sc_lv 16 signal 2 } 
	{ stream_Brd_Acq_Real_out_1_MAD_Computation_raw_data_real_i_empty_n sc_in sc_logic 1 signal 2 } 
	{ stream_Brd_Acq_Real_out_1_MAD_Computation_raw_data_real_i_read sc_out sc_logic 1 signal 2 } 
	{ stream_Brd_Acq_Im_out_0_MAD_Computation_raw_data_im_i_dout sc_in sc_lv 16 signal 3 } 
	{ stream_Brd_Acq_Im_out_0_MAD_Computation_raw_data_im_i_empty_n sc_in sc_logic 1 signal 3 } 
	{ stream_Brd_Acq_Im_out_0_MAD_Computation_raw_data_im_i_read sc_out sc_logic 1 signal 3 } 
	{ RDRi_V_address0 sc_out sc_lv 11 signal 0 } 
	{ RDRi_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ RDRi_V_we0 sc_out sc_logic 1 signal 0 } 
	{ RDRi_V_d0 sc_out sc_lv 16 signal 0 } 
	{ RDIi_V_address0 sc_out sc_lv 11 signal 1 } 
	{ RDIi_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ RDIi_V_we0 sc_out sc_logic 1 signal 1 } 
	{ RDIi_V_d0 sc_out sc_lv 16 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "RDRi_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "RDRi_V", "role": "address0" }} , 
 	{ "name": "RDRi_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "RDRi_V", "role": "ce0" }} , 
 	{ "name": "RDRi_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "RDRi_V", "role": "we0" }} , 
 	{ "name": "RDRi_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "RDRi_V", "role": "d0" }} , 
 	{ "name": "RDIi_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "RDIi_V", "role": "address0" }} , 
 	{ "name": "RDIi_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "RDIi_V", "role": "ce0" }} , 
 	{ "name": "RDIi_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "RDIi_V", "role": "we0" }} , 
 	{ "name": "RDIi_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "RDIi_V", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	RDRi_V { ap_memory {  { RDRi_V_address0 mem_address 1 11 }  { RDRi_V_ce0 mem_ce 1 1 }  { RDRi_V_we0 mem_we 1 1 }  { RDRi_V_d0 mem_din 1 16 } } }
	RDIi_V { ap_memory {  { RDIi_V_address0 mem_address 1 11 }  { RDIi_V_ce0 mem_ce 1 1 }  { RDIi_V_we0 mem_we 1 1 }  { RDIi_V_d0 mem_din 1 16 } } }
