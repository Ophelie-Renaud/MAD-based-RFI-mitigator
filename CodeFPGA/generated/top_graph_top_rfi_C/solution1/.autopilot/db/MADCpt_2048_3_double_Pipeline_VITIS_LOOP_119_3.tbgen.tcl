set moduleName MADCpt_2048_3_double_Pipeline_VITIS_LOOP_119_3
set isTopModule 0
...
set C_modelName {MADCpt<2048, 3, double>_Pipeline_VITIS_LOOP_119_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ MRo double 64 regular {array 2048 { 1 3 } 1 1 }  }
	{ MIo double 64 regular {array 2048 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "MRo", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "MIo", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ MRo_q0 sc_in sc_lv 64 signal 0 } 
	{ MIo_address0 sc_out sc_lv 11 signal 1 } 
	{ MIo_ce0 sc_out sc_logic 1 signal 1 } 
	{ MIo_q0 sc_in sc_lv 64 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "MRo_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "MRo", "role": "q0" }} , 
 	...
 	{ "name": "MIo_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "MIo", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	MRo { ap_memory {  { MRo_address0 mem_address 1 11 }  { MRo_ce0 mem_ce 1 1 }  { MRo_q0 in_data 0 64 } } }
	MIo { ap_memory {  { MIo_address0 mem_address 1 11 }  { MIo_ce0 mem_ce 1 1 }  { MIo_q0 in_data 0 64 } } }
