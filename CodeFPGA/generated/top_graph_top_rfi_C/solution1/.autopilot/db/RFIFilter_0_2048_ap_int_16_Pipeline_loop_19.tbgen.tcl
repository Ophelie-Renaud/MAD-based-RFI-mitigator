set moduleName RFIFilter_0_2048_ap_int_16_Pipeline_loop_19
set isTopModule 0
...
set C_modelName {RFIFilter<0, 2048, ap_int<16> >_Pipeline_loop_19}
set C_modelType { void 0 }
set C_modelArgList {
	{ RIi_V int 16 regular {array 2048 { 1 3 } 1 1 }  }
	{ sub_i_i46_i_i int 17 regular  }
	{ RIo_V int 16 regular {array 2048 { 0 3 } 0 1 }  }
	{ select_ln1558 int 16 regular  }
	{ conv_i20_i_i int 16 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "RIi_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "sub_i_i46_i_i", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "RIo_V", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ RIi_V_address0 sc_out sc_lv 11 signal 0 } 
	{ RIi_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ RIi_V_q0 sc_in sc_lv 16 signal 0 } 
	{ sub_i_i46_i_i sc_in sc_lv 17 signal 1 } 
	{ RIo_V_address0 sc_out sc_lv 11 signal 2 } 
	{ RIo_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ RIo_V_we0 sc_out sc_logic 1 signal 2 } 
	{ RIo_V_d0 sc_out sc_lv 16 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "RIi_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "RIi_V", "role": "q0" }} , 
 	...
 	{ "name": "RIo_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "RIo_V", "role": "we0" }} , 
 	{ "name": "RIo_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "RIo_V", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	RIi_V { ap_memory {  { RIi_V_address0 mem_address 1 11 }  { RIi_V_ce0 mem_ce 1 1 }  { RIi_V_q0 in_data 0 16 } } }
	sub_i_i46_i_i { ap_none {  { sub_i_i46_i_i in_data 0 17 } } }
	RIo_V { ap_memory {  { RIo_V_address0 mem_address 1 11 }  { RIo_V_ce0 mem_ce 1 1 }  { RIo_V_we0 mem_we 1 1 }  { RIo_V_d0 mem_din 1 16 } } }
