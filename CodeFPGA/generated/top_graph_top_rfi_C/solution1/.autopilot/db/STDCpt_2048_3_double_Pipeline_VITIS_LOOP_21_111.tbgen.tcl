set moduleName STDCpt_2048_3_double_Pipeline_VITIS_LOOP_21_111
set isTopModule 0
...
set C_modelName {STDCpt<2048, 3, double>_Pipeline_VITIS_LOOP_21_111}
set C_modelType { void 0 }
set C_modelArgList {
	{ RIi double 64 regular {array 2048 { 1 3 } 1 1 }  }
	{ sum_2_out double 64 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "RIi", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "sum_2_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sum_2_out sc_out sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_2_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "sum_2_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sum_2_out { ap_vld {  { sum_2_out out_data 1 64 }  { sum_2_out_ap_vld out_vld 1 1 } } }
}
