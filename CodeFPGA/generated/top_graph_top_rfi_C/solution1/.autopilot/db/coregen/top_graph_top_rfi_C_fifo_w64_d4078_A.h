...
// ==============================================================
#ifndef top_graph_top_rfi_C_fifo_w64_d4078_A_HH_
#define top_graph_top_rfi_C_fifo_w64_d4078_A_HH_

#include <systemc>
using namespace std;
SC_MODULE(top_graph_top_rfi_C_fifo_w64_d4078_A) {
    static const unsigned int DATA_WIDTH = 64;
    static const unsigned int ADDR_WIDTH = 12;
    static const unsigned int top_graph_top_rfi_C_fifo_w64_d4078_A_depth = 4079;
    ...
    sc_core::sc_signal< sc_dt::sc_lv<DATA_WIDTH> >  mStorage[top_graph_top_rfi_C_fifo_w64_d4078_A_depth];
    ...
    SC_CTOR(top_graph_top_rfi_C_fifo_w64_d4078_A) : mTrace(0) {
        ...
        SC_METHOD(proc_dout);
        sensitive << mOutPtr;
        for (unsigned i = 0; i < top_graph_top_rfi_C_fifo_w64_d4078_A_depth; i++) {
        ...
        if (reset.read() == sc_dt::SC_LOGIC_1) {
            ...
            if (if_read_ce.read() == sc_dt::SC_LOGIC_1
               ...
               && internal_empty_n.read() == sc_dt::SC_LOGIC_1) {
                ...
                if (mOutPtr.read().to_uint() == (top_graph_top_rfi_C_fifo_w64_d4078_A_depth-1)) {
                    ptr = 0;
                ...
                assert(ptr.to_uint() < top_graph_top_rfi_C_fifo_w64_d4078_A_depth);
                mOutPtr.write(ptr);
            }
            if (if_write_ce.read() == sc_dt::SC_LOGIC_1
                ...
                if (ptr.to_uint() == (top_graph_top_rfi_C_fifo_w64_d4078_A_depth-1)) {
                    ptr = 0;
                    mFlag_nEF_hint.write(~mFlag_nEF_hint.read());
                } else {
                    ptr++;
    ...
    void proc_dout() {
        ...
        if (ptr.to_uint() > top_graph_top_rfi_C_fifo_w64_d4078_A_depth) {
...
#endif //top_graph_top_rfi_C_fifo_w64_d4078_A_HH_
