...
extern "C" void top_graph_top_rfi_C(__cosim_s2__*, __cosim_s2__*, __cosim_s2__*, __cosim_s2__*, __cosim_s2__*, __cosim_s2__*, __cosim_s2__*, __cosim_s2__*, __cosim_s2__*, __cosim_s2__*, __cosim_s2__*, __cosim_s2__*, __cosim_s2__*, __cosim_s2__*);
extern "C" void apatb_top_graph_top_rfi_C_hw(volatile void * __xlx_apatb_param_raw_data_real_i_stream, volatile void * __xlx_apatb_param_raw_data_im_i_stream, volatile void * __xlx_apatb_param_raw_data_im_o_stream, volatile void * __xlx_apatb_param_raw_data_real_o_stream, volatile void * __xlx_apatb_param_mad_R_o_stream, volatile void * __xlx_apatb_param_raw_data_real_1_o_stream, volatile void * __xlx_apatb_param_std_R_o_stream, volatile void * __xlx_apatb_param_raw_data_im_1_o_stream, volatile void * __xlx_apatb_param_mad_I_o_stream, volatile void * __xlx_apatb_param_std_I_o_stream, volatile void * __xlx_apatb_param_filtered_im_0_o_stream, volatile void * __xlx_apatb_param_filtered_real_0_o_stream, volatile void * __xlx_apatb_param_filtered_im_1_o_stream, volatile void * __xlx_apatb_param_filtered_real_1_o_stream) {
  ...
  vector<__cosim_s2__> __xlx_raw_data_real_i_stream_tmp_vec;
  while (!((hls::stream<__cosim_s2__>*)__xlx_apatb_param_raw_data_real_i_stream)->empty() && __xlx_raw_data_real_i_stream_V_tmp_Count < __xlx_raw_data_real_i_stream_V_read_Size) {
    __xlx_raw_data_real_i_stream_tmp_vec.push_back(((hls::stream<__cosim_s2__>*)__xlx_apatb_param_raw_data_real_i_stream)->read());
    __xlx_raw_data_real_i_stream_V_tmp_Count++;
  }
  ap_apatb_raw_data_real_i_stream_cap_bc = __xlx_raw_data_real_i_stream_tmp_vec.size();
  // store input buffer
  __cosim_s2__* __xlx_raw_data_real_i_stream_input_buffer= new __cosim_s2__[__xlx_raw_data_real_i_stream_tmp_vec.size()];
  ...
  vector<__cosim_s2__> __xlx_raw_data_im_i_stream_tmp_vec;
  while (!((hls::stream<__cosim_s2__>*)__xlx_apatb_param_raw_data_im_i_stream)->empty() && __xlx_raw_data_im_i_stream_V_tmp_Count < __xlx_raw_data_im_i_stream_V_read_Size) {
    __xlx_raw_data_im_i_stream_tmp_vec.push_back(((hls::stream<__cosim_s2__>*)__xlx_apatb_param_raw_data_im_i_stream)->read());
    __xlx_raw_data_im_i_stream_V_tmp_Count++;
  }
  ap_apatb_raw_data_im_i_stream_cap_bc = __xlx_raw_data_im_i_stream_tmp_vec.size();
  // store input buffer
  __cosim_s2__* __xlx_raw_data_im_i_stream_input_buffer= new __cosim_s2__[__xlx_raw_data_im_i_stream_tmp_vec.size()];
  ...
  __cosim_s2__* __xlx_raw_data_im_o_stream_input_buffer= new __cosim_s2__[ap_apatb_raw_data_im_o_stream_cap_bc];
  ...
  __cosim_s2__* __xlx_raw_data_real_o_stream_input_buffer= new __cosim_s2__[ap_apatb_raw_data_real_o_stream_cap_bc];
  //Create input buffer for mad_R_o_stream
  ap_apatb_mad_R_o_stream_cap_bc = __xlx_mad_R_o_stream_V_size_Reader.read_size();
  __cosim_s2__* __xlx_mad_R_o_stream_input_buffer= new __cosim_s2__[ap_apatb_mad_R_o_stream_cap_bc];
  ...
  __cosim_s2__* __xlx_raw_data_real_1_o_stream_input_buffer= new __cosim_s2__[ap_apatb_raw_data_real_1_o_stream_cap_bc];
  //Create input buffer for std_R_o_stream
  ap_apatb_std_R_o_stream_cap_bc = __xlx_std_R_o_stream_V_size_Reader.read_size();
  __cosim_s2__* __xlx_std_R_o_stream_input_buffer= new __cosim_s2__[ap_apatb_std_R_o_stream_cap_bc];
  ...
  __cosim_s2__* __xlx_raw_data_im_1_o_stream_input_buffer= new __cosim_s2__[ap_apatb_raw_data_im_1_o_stream_cap_bc];
  //Create input buffer for mad_I_o_stream
  ap_apatb_mad_I_o_stream_cap_bc = __xlx_mad_I_o_stream_V_size_Reader.read_size();
  __cosim_s2__* __xlx_mad_I_o_stream_input_buffer= new __cosim_s2__[ap_apatb_mad_I_o_stream_cap_bc];
  //Create input buffer for std_I_o_stream
  ap_apatb_std_I_o_stream_cap_bc = __xlx_std_I_o_stream_V_size_Reader.read_size();
  __cosim_s2__* __xlx_std_I_o_stream_input_buffer= new __cosim_s2__[ap_apatb_std_I_o_stream_cap_bc];
  ...
  __cosim_s2__* __xlx_filtered_im_0_o_stream_input_buffer= new __cosim_s2__[ap_apatb_filtered_im_0_o_stream_cap_bc];
  ...
  __cosim_s2__* __xlx_filtered_real_0_o_stream_input_buffer= new __cosim_s2__[ap_apatb_filtered_real_0_o_stream_cap_bc];
  ...
  __cosim_s2__* __xlx_filtered_im_1_o_stream_input_buffer= new __cosim_s2__[ap_apatb_filtered_im_1_o_stream_cap_bc];
  ...
  __cosim_s2__* __xlx_filtered_real_1_o_stream_input_buffer= new __cosim_s2__[ap_apatb_filtered_real_1_o_stream_cap_bc];
  // DUT call
  ...
  for (unsigned i = 0; i <ap_apatb_raw_data_im_o_stream_cap_bc; ++i)
    ((hls::stream<__cosim_s2__>*)__xlx_apatb_param_raw_data_im_o_stream)->write(__xlx_raw_data_im_o_stream_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_raw_data_real_o_stream_cap_bc; ++i)
    ((hls::stream<__cosim_s2__>*)__xlx_apatb_param_raw_data_real_o_stream)->write(__xlx_raw_data_real_o_stream_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_mad_R_o_stream_cap_bc; ++i)
    ((hls::stream<__cosim_s2__>*)__xlx_apatb_param_mad_R_o_stream)->write(__xlx_mad_R_o_stream_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_raw_data_real_1_o_stream_cap_bc; ++i)
    ((hls::stream<__cosim_s2__>*)__xlx_apatb_param_raw_data_real_1_o_stream)->write(__xlx_raw_data_real_1_o_stream_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_std_R_o_stream_cap_bc; ++i)
    ((hls::stream<__cosim_s2__>*)__xlx_apatb_param_std_R_o_stream)->write(__xlx_std_R_o_stream_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_raw_data_im_1_o_stream_cap_bc; ++i)
    ((hls::stream<__cosim_s2__>*)__xlx_apatb_param_raw_data_im_1_o_stream)->write(__xlx_raw_data_im_1_o_stream_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_mad_I_o_stream_cap_bc; ++i)
    ((hls::stream<__cosim_s2__>*)__xlx_apatb_param_mad_I_o_stream)->write(__xlx_mad_I_o_stream_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_std_I_o_stream_cap_bc; ++i)
    ((hls::stream<__cosim_s2__>*)__xlx_apatb_param_std_I_o_stream)->write(__xlx_std_I_o_stream_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_filtered_im_0_o_stream_cap_bc; ++i)
    ((hls::stream<__cosim_s2__>*)__xlx_apatb_param_filtered_im_0_o_stream)->write(__xlx_filtered_im_0_o_stream_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_filtered_real_0_o_stream_cap_bc; ++i)
    ((hls::stream<__cosim_s2__>*)__xlx_apatb_param_filtered_real_0_o_stream)->write(__xlx_filtered_real_0_o_stream_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_filtered_im_1_o_stream_cap_bc; ++i)
    ((hls::stream<__cosim_s2__>*)__xlx_apatb_param_filtered_im_1_o_stream)->write(__xlx_filtered_im_1_o_stream_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_filtered_real_1_o_stream_cap_bc; ++i)
    ((hls::stream<__cosim_s2__>*)__xlx_apatb_param_filtered_real_1_o_stream)->write(__xlx_filtered_real_1_o_stream_input_buffer[i]);
}
