...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename count_V \
    op interface \
    ports { count_V_address0 { O 11 vector } count_V_ce0 { O 1 bit } count_V_we0 { O 1 bit } count_V_d0 { O 16 vector } count_V_address1 { O 11 vector } count_V_ce1 { O 1 bit } count_V_q1 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'count_V'"
}
}
