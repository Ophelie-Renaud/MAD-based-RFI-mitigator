...
module top_graph_top_rfi_C_STDCpt_2048_3_double_Pipeline_loop_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [11:0] i_4_reg_131;
reg    ap_block_pp0_stage0_11001;
wire   [63:0] i_cast_i_fu_109_p1;
reg   [11:0] i_fu_42;
wire   [11:0] add_ln50_fu_98_p2;
wire    ap_loop_init;
...
assign RIi_d0 = stream_Brd_Acq_Im_out_1_STD_Computation_raw_data_im_i_dout;

assign RRi_address0 = i_cast_i_fu_109_p1;

assign RRi_d0 = stream_Brd_Acq_Real_out_2_STD_Computation_raw_data_real_i_dout;

assign add_ln50_fu_98_p2 = (ap_sig_allocacmp_i_4 + 12'd1);
...
assign i_cast_i_fu_109_p1 = i_4_reg_131;

assign icmp_ln50_fu_92_p2 = ((ap_sig_allocacmp_i_4 == 12'd2048) ? 1'b1 : 1'b0);

endmodule //top_graph_top_rfi_C_STDCpt_2048_3_double_Pipeline_loop_2
