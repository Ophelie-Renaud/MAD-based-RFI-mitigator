...
module top_graph_top_rfi_C_hls_deadlock_idx0_monitor ( // for module top_graph_top_rfi_C_top_graph_top_rfi_C_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[1] = idx2_block & (1'b0 | axis_block_sigs[3] | axis_block_sigs[4] | axis_block_sigs[5]);
...
assign process_axis_block_vec[9] = idx7_block & (1'b0 | axis_block_sigs[10] | axis_block_sigs[11]);
assign process_idle_vec[9] = inst_idle_sigs[9];
assign process_chan_block_vec[9] = inst_block_sigs[9];
assign process_axis_block_vec[10] = idx8_block & (1'b0 | axis_block_sigs[12] | axis_block_sigs[13]);
...
// instant sub module
 top_graph_top_rfi_C_hls_deadlock_idx2_monitor top_graph_top_rfi_C_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 top_graph_top_rfi_C_hls_deadlock_idx1_monitor top_graph_top_rfi_C_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
