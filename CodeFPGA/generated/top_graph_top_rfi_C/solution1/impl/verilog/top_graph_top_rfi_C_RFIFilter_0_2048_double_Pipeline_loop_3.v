...
module top_graph_top_rfi_C_RFIFilter_0_2048_double_Pipeline_loop_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] i_13_cast_i_fu_106_p1;
reg   [11:0] i_fu_42;
wire   [11:0] add_ln67_fu_100_p2;
wire    ap_loop_init;
reg   [11:0] ap_sig_allocacmp_i_8;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln67_fu_94_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln67_fu_94_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign RIo_address0 = i_13_cast_i_fu_106_p1;

assign RRo_address0 = i_13_cast_i_fu_106_p1;

assign add_ln67_fu_100_p2 = (ap_sig_allocacmp_i_8 + 12'd1);
...
assign i_13_cast_i_fu_106_p1 = ap_sig_allocacmp_i_8;

assign icmp_ln67_fu_94_p2 = ((ap_sig_allocacmp_i_8 == 12'd2048) ? 1'b1 : 1'b0);

assign stream_RFI_Filter_filtered_im_data_o_Brd_Res_Im_in_din = RIo_q0;

assign stream_RFI_Filter_filtered_real_data_o_Brd_Res_Real_in_din = RRo_q0;

endmodule //top_graph_top_rfi_C_RFIFilter_0_2048_double_Pipeline_loop_3
