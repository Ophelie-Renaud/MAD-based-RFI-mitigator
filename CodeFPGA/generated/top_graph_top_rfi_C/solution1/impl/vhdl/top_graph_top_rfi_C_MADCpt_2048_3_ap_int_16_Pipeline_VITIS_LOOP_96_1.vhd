...
entity top_graph_top_rfi_C_MADCpt_2048_3_ap_int_16_Pipeline_VITIS_LOOP_96_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of top_graph_top_rfi_C_MADCpt_2048_3_ap_int_16_Pipeline_VITIS_LOOP_96_1 is 
...
attribute shreg_extract : string;
    ...
    signal i_V_23_reg_123 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal zext_ln587_fu_111_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_V_fu_42 : STD_LOGIC_VECTOR (11 downto 0);
    signal i_V_24_fu_100_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_V_23 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                i_V_23_reg_123 <= ap_sig_allocacmp_i_V_23;
            end if;
        end if;
    end process;
    ...
    RDIi_V_address0 <= zext_ln587_fu_111_p1(11 - 1 downto 0);

    RDIi_V_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            RDIi_V_ce0 <= ap_const_logic_1;
        else 
            RDIi_V_ce0 <= ap_const_logic_0;
        end if; 
    end process;

    RDIi_V_d0 <= stream_Brd_Acq_Im_out_0_MAD_Computation_raw_data_im_i_dout;

    RDIi_V_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            RDIi_V_we0 <= ap_const_logic_1;
        else 
            RDIi_V_we0 <= ap_const_logic_0;
        end if; 
    end process;

    RDRi_V_address0 <= zext_ln587_fu_111_p1(11 - 1 downto 0);

    RDRi_V_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            RDRi_V_ce0 <= ap_const_logic_1;
        else 
            RDRi_V_ce0 <= ap_const_logic_0;
        end if; 
    end process;

    RDRi_V_d0 <= stream_Brd_Acq_Real_out_1_MAD_Computation_raw_data_real_i_dout;

    RDRi_V_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            RDRi_V_we0 <= ap_const_logic_1;
        else 
    ...
    ap_sig_allocacmp_i_V_23_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_V_fu_42, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_i_V_23 <= ap_const_lv12_0;
        else 
            ap_sig_allocacmp_i_V_23 <= i_V_fu_42;
        end if; 
    end process;

    i_V_24_fu_100_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_V_23) + unsigned(ap_const_lv12_1));
    icmp_ln1072_fu_94_p2 <= "1" when (ap_sig_allocacmp_i_V_23 = ap_const_lv12_800) else "0";
    ...
    zext_ln587_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_V_23_reg_123),64));
end behav;
