...
module top_graph_top_rfi_C_MADCpt_2048_3_ap_int_16_Pipeline_VITIS_LOOP_83_110 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg  signed [16:0] rhs_25_i_cast_reg_152;
...
reg   [11:0] i_V_fu_40;
wire   [11:0] i_V_28_fu_94_p2;
wire    ap_loop_init;
reg   [11:0] ap_sig_allocacmp_i_V_27;
...
assign deviation_list_I_V_address0 = zext_ln587_reg_161_pp0_iter1_reg;

assign deviation_list_I_V_d0 = select_ln180_reg_171;

assign i_V_28_fu_94_p2 = (ap_sig_allocacmp_i_V_27 + 12'd1);

assign icmp_ln1072_fu_88_p2 = ((ap_sig_allocacmp_i_V_27 == 12'd2048) ? 1'b1 : 1'b0);

assign ret_fu_114_p2 = ($signed(sext_ln232_fu_110_p1) - $signed(rhs_25_i_cast_reg_152));
...
assign zext_ln587_fu_100_p1 = ap_sig_allocacmp_i_V_27;
...
endmodule //top_graph_top_rfi_C_MADCpt_2048_3_ap_int_16_Pipeline_VITIS_LOOP_83_110
