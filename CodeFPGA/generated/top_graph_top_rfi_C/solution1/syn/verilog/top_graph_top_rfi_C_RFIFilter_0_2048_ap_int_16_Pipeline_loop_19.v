...
reg   [11:0] i_V_22_fu_46;
wire   [11:0] i_V_23_fu_108_p2;
wire    ap_loop_init;
...
wire   [0:0] icmp_ln1072_1_fu_136_p2;
...
assign RIo_V_address0 = zext_ln587_reg_205_pp0_iter1_reg;

assign RIo_V_d0 = select_ln22_reg_215;

assign and_ln22_fu_141_p2 = (tmp_fu_128_p3 & icmp_ln1072_1_fu_136_p2);
...
assign i_V_23_fu_108_p2 = (ap_sig_allocacmp_i_V + 12'd1);

assign icmp_ln1072_1_fu_136_p2 = (($signed(sext_ln1072_fu_124_p1) < $signed(sub_i_i46_i_i)) ? 1'b1 : 1'b0);

assign icmp_ln1072_fu_102_p2 = ((ap_sig_allocacmp_i_V == 12'd2048) ? 1'b1 : 1'b0);

assign icmp_ln1080_1_fu_153_p0 = RIi_V_q0;

assign icmp_ln1080_1_fu_153_p2 = (($signed(icmp_ln1080_1_fu_153_p0) > $signed(select_ln1558)) ? 1'b1 : 1'b0);

assign icmp_ln1080_fu_147_p0 = RIi_V_q0;
