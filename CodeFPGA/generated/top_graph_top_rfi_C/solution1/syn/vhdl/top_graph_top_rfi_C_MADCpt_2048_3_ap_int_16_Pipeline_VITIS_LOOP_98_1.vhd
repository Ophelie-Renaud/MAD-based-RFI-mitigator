...
entity top_graph_top_rfi_C_MADCpt_2048_3_ap_int_16_Pipeline_VITIS_LOOP_98_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of top_graph_top_rfi_C_MADCpt_2048_3_ap_int_16_Pipeline_VITIS_LOOP_98_1 is 
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                i_V_25_reg_123 <= ap_sig_allocacmp_i_V_25;
            end if;
        end if;
    end process;
    ...
    ap_sig_allocacmp_i_V_25_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_V_fu_42, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_i_V_25 <= ap_const_lv12_0;
        else 
            ap_sig_allocacmp_i_V_25 <= i_V_fu_42;
        end if; 
    end process;

    i_V_26_fu_100_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_V_25) + unsigned(ap_const_lv12_1));
    icmp_ln1072_fu_94_p2 <= "1" when (ap_sig_allocacmp_i_V_25 = ap_const_lv12_800) else "0";
    ...
    zext_ln587_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_V_25_reg_123),64));
end behav;
