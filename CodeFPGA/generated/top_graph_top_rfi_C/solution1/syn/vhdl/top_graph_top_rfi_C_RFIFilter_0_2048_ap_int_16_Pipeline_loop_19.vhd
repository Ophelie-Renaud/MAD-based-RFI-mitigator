...
attribute shreg_extract : string;
    ...
    signal i_V_22_fu_46 : STD_LOGIC_VECTOR (11 downto 0);
    signal i_V_23_fu_108_p2 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal icmp_ln1072_1_fu_136_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    RIo_V_address0 <= zext_ln587_reg_205_pp0_iter1_reg(11 - 1 downto 0);
    ...
    and_ln22_fu_141_p2 <= (tmp_fu_128_p3 and icmp_ln1072_1_fu_136_p2);
    ...
    ap_sig_allocacmp_i_V_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_V_22_fu_46, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_i_V <= ap_const_lv12_0;
        else 
            ap_sig_allocacmp_i_V <= i_V_22_fu_46;
        end if; 
    end process;

    i_V_23_fu_108_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_V) + unsigned(ap_const_lv12_1));
    icmp_ln1072_1_fu_136_p2 <= "1" when (signed(sext_ln1072_fu_124_p1) < signed(sub_i_i46_i_i)) else "0";
    icmp_ln1072_fu_102_p2 <= "1" when (ap_sig_allocacmp_i_V = ap_const_lv12_800) else "0";
    icmp_ln1080_1_fu_153_p0 <= RIi_V_q0;
    icmp_ln1080_1_fu_153_p2 <= "1" when (signed(icmp_ln1080_1_fu_153_p0) > signed(select_ln1558)) else "0";
    icmp_ln1080_fu_147_p0 <= RIi_V_q0;
