...
module top_graph_top_rfi_C_MADCpt_2048_3_ap_int_16_Pipeline_VITIS_LOOP_81_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg  signed [16:0] rhs_i_cast_reg_150;
...
reg   [11:0] i_V_26_fu_40;
wire   [11:0] i_V_27_fu_94_p2;
wire    ap_loop_init;
...
assign deviation_list_R_V_address0 = zext_ln587_reg_159_pp0_iter1_reg;

assign deviation_list_R_V_d0 = ((tmp_reg_175[0:0] == 1'b1) ? sub_ln180_fu_131_p2 : trunc_ln180_reg_169);

assign i_V_27_fu_94_p2 = (ap_sig_allocacmp_i_V + 12'd1);

assign icmp_ln1072_fu_88_p2 = ((ap_sig_allocacmp_i_V == 12'd2048) ? 1'b1 : 1'b0);

assign ret_fu_114_p2 = ($signed(sext_ln232_fu_110_p1) - $signed(rhs_i_cast_reg_150));
...
endmodule //top_graph_top_rfi_C_MADCpt_2048_3_ap_int_16_Pipeline_VITIS_LOOP_81_1
