...
<dftools:workflow errorOnWarning="true" verboseLevel="INFO" xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task
        ...
        <dftools:data key="variables">
            <dftools:variable name="path" value="/Code/"/>
        </dftools:data>
    </dftools:task>
    ...
    <dftools:task
        pluginId="org.ietr.preesm.memory.bounds.MemoryBoundsEstimator" taskId="Memory Bound Estimator">
        <dftools:data key="variables">
    ...
    <dftools:dataTransfer from="MEG Builder" sourceport="MemEx"
        targetport="MemEx" to="Memory Bound Estimator"/>
    <dftools:dataTransfer from="MEG Builder" sourceport="MemEx"
